// lib/teacher/pre_test_completion.dart
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:fl_chart/fl_chart.dart';

class PreTestCompletionScreen extends StatefulWidget {
  @override
  _PreTestCompletionScreenState createState() => _PreTestCompletionScreenState();
}

class _PreTestCompletionScreenState extends State<PreTestCompletionScreen> {
  ...
  void initState() {
    super.initState();
    _loadPreTestCompletionData();
  }

  Future<void> _loadPreTestCompletionData() async {
    ...
    try {
      ...
      print('Error loading pre-test completion: $e');
      if (mounted) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('กราฟจำนวนการสอบก่อนเรียน'),
