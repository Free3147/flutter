// lib/teacher/pre_test_average_score.dart
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:fl_chart/fl_chart.dart';

class PreTestAverageScoreScreen extends StatefulWidget {
  @override
  _PreTestAverageScoreScreenState createState() => _PreTestAverageScoreScreenState();
}

class _PreTestAverageScoreScreenState extends State<PreTestAverageScoreScreen> {
  ...
  void initState() {
    super.initState();
    _loadPreTestAverageScoreData();
  }

  Future<void> _loadPreTestAverageScoreData() async {
    ...
    try {
      ...
      // 🔹 ขั้นตอน 2: คำนวณคะแนนเฉลี่ยจาก progress
      ...
      for (final entry in classRooms.entries) {
        ...
        for (final uid in uids) {
          ...
          if (progressDoc.exists) {
            ...
            final preTestScore = progressData['preTestScore'] as int?;
      ...
      print('Error loading pre-test average score: $e');
      if (mounted) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('คะแนนเฉลี่ยการสอบก่อนเรียน'),
                                  ...
                                  child: PieChart(
                                    PieChartData(
                                      sections: [
                                        PieChartSectionData(
                                          value: percentage,
                                          color: Colors.blue, // สีน้ำเงินสำหรับก่อนเรียน
